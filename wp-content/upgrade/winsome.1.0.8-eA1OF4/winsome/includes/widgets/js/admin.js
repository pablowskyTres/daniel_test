...
jQuery(function($){
  ////////////////////////////////
      ...
      jQuery(document).on('click', 'input.select-img', function( event ){
        ...
        var WinsomeImage = wp.media.controller.Library.extend({
            defaults :  _.defaults({
        ...
        winsome_file_frame = wp.media.frames.winsome_file_frame = wp.media({
          button: {
        ...
        winsome_file_frame.on( 'select', function() {

          var state = winsome_file_frame.state('rtam-insert-image');
